...
This is a basic todo list application written for Amazon's tech screening. It will help you achieve
all your dreams and goals like magic. Thus... tada!
...
demonstration only.
* The backend uses Express.js as part of the requirements, but perhaps one day Golang would be a
consideration for migrating to.
...
As per the requirements this project showcases using slices for tasks. However, it also showcases
using RTK Query just for the fun of it when it comes to using categories and users.
